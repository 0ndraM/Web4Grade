        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div class="md:col-span-1">
                ...
                <p class="text-gray-500 dark:text-slate-400 text-sm leading-relaxed mb-6">
                    Pomáháme studentům s realizací školních webových projektů. Kvalitní kód, moderní design a férový přístup.
                </p>
                <div class="flex gap-4" >
                    <a href="#https://www.instagram.com/web4grade/" class="w-8 h-8 bg-gray-50 dark:bg-slate-800 text-gray-400 rounded-lg flex items-center justify-center hover:bg-blue-50 dark:hover:bg-blue-900/30 hover:text-blue-600 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                    </a>
                    <a href="#" class="w-8 h-8 bg-gray-50 dark:bg-slate-800 text-gray-400 rounded-lg flex items-center justify-center hover:bg-blue-50 dark:hover:bg-blue-900/30 hover:text-blue-600 transition" style="visibility: hidden">
